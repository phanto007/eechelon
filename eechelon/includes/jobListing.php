...
<div id="page-content" class="page-content bg bg-cover bg-transparent header-clear">
    <div id="page-content-scroll">
        ...
        <?php
        	global $con;
			$sql = mysqli_query($con, "SELECT jobID, job_title, deliveryFee FROM job_list WHERE status='a'");		
	        while($result = mysqli_fetch_array($sql)){
	    ?>
	           
       
            <a href="jobListing?jobID=<?php echo $result['jobID'] ?>" class="store-menu-card">
                <h1>
