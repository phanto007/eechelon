                ...
                <div class="pageapp-login">
                    ...
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	                    ...
	                    <div class="pageapp-login-links">
	                        <a href="#" class="page-login-forgot"><i class="fa fa-eye"></i>Forgot Password</a>
	                        <a href="signup" class="page-login-create">Create Account<i class="fa fa-user"></i></a>
	                        <div class="clear"></div>
	                    </div>
	                    
	                    <input type="submit" value="Login" class="button button-green button-icon button-full half-top full-bottom">
                    </form>
