...
<div id="page-content" class="page-content header-clear fadeIn show-containers">
    <div id="page-content-scroll" style="right: 0px;">
        ...
        <div class="content no-bottom material-full-top">
            <div class="container no-bottom">
                <div class="one-half-responsive">
                    ...
                    <a href="#" <?php if($result['status']=='c' && $result['start_coord']!=NULL) echo "onclick=\"location.href ='qrverify?jobID=".$jobID."';\""; elseif($result['status']=='c' && $result['start_coord']==NULL) echo "onclick=\"location.href ='purchasedPackage?jobID=".$jobID."';\""; ?> class="tasklist-item tasklist-green <?php if($result['status']=='e' || $result['status']=='g') echo 'tasklist-completed'; ?>">             
                        <i class="fa fa-check"></i>
                        <h5>Item Purchased/Picked Up</h5>
                    </a>
                                        
                    <a href="#" <?php if($result['status']=='e') echo "onclick=\"location.href ='qrverify?jobID=".$jobID."';\""; ?> class="tasklist-item tasklist-blue <?php if($result['status']=='g') echo 'tasklist-completed'; ?>">
                        <i class="fa fa-check"></i>
                        <h5>Deliveried</h5>
                    </a>
        ...
        <a href="onGoingJobs" class="button button-round button-red">Back</a>
        <div class="decoration decoration-margins"></div>
    </div>  
</div>
